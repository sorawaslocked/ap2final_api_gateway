...
type (
	...
	Client struct {
		...
		ActorServiceURL   string        `yaml:"actorServiceURL" env:"GRPC_ACTOR_SERVICE_URL" env-required:"true"`
		SessionServiceURL string        `yaml:"sessionServiceURL" env:"GRPC_SESSION_SERVICE_URL" env-required:"true"`
